...
int vp9_full_search_sad_c(struct macroblock *x, struct mv *ref_mv, int sad_per_bit, int distance, struct vp9_variance_vtable *fn_ptr, DEC_MVCOSTS, const struct mv *center_mv, int n);
#define vp9_full_search_sad vp9_full_search_sad_c

int vp9_refining_search_sad_c(struct macroblock *x, struct mv *ref_mv, int sad_per_bit, int distance, struct vp9_variance_vtable *fn_ptr, DEC_MVCOSTS, const struct mv *center_mv);
#define vp9_refining_search_sad vp9_refining_search_sad_c

int vp9_diamond_search_sad_c(struct macroblock *x, struct mv *ref_mv, struct mv *best_mv, int search_param, int sad_per_bit, int *num00, struct vp9_variance_vtable *fn_ptr, DEC_MVCOSTS, const struct mv *center_mv);
#define vp9_diamond_search_sad vp9_diamond_search_sad_c

int vp9_full_range_search_c(struct macroblock *x, struct mv *ref_mv, struct mv *best_mv, int search_param, int sad_per_bit, int *num00, struct vp9_variance_vtable *fn_ptr, DEC_MVCOSTS, const struct mv *center_mv);
