...
import com.example.intern.giftest.clipart.util.BitmapManager;
import com.example.intern.giftest.clipart.util.Geom;
...
public class ClipartView extends AbstractItem implements GestureDetector.GestureListener {
    ...
    private List<AbstractItem.DrawPath> drawPaths = new ArrayList<>();
